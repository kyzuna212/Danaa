 ...
 * Generated at: 2020-09-28 12:18:08 UTC
...
public final class NewFile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("      받는사람 : <input type=\"text\" id=\"to\" name=\"to\"/>   <!-- 인증번호 받을사람 휴대폰 번호 -->\r\n");
      out.write("    <input type=\"button\" id=\"send\" value=\"전송\"/><br> <!-- 문자보내는 전송버튼 -->\r\n");
      out.write("     인증번호 :    <input type=\"text\" id=\"userNum\">   <!-- 인증번호 입력창 -->\r\n");
      out.write("  <input type=\"button\" id=\"enterBtn\" value=\"확인\">   <!-- 인증번호와 내가 입력창에 입력한 인증번호 비교하는 창 -->\r\n");
      out.write("  \r\n");
      out.write("  \r\n");
      out.write("  <input type=\"hidden\" name=\"text\" id=\"text\">   <!-- 인증번호를 히든으로 저장해서 보낸다 -->\r\n");
      out.write(" \r\n");
      out.write("</form>  \r\n");
      out.write("    </div>\r\n");
      out.write("  <script>\r\n");
      ...
      out.write("          }\r\n");
      out.write("\r\n");
      out.write("          $(\"#text\").val(number);      /* 난수로 생성된 인증번호를 hidden name : text 에 숨긴다 */\r\n");
      out.write("       \r\n");
      ...
      out.write("       \r\n");
      out.write("       else {\r\n");
      out.write("       var con_test = confirm(\"해당번호로 인증문자를 발송하시겠습니까?\");   /* 문자를 보낼껀지 물어본다 */\r\n");
      out.write("          \r\n");
      out.write("          if(con_test == true){\r\n");
      out.write("               \r\n");
      out.write("             if(count < 3){      /* 추후 데이터베이스에 컬럼 값을 확인하여 count 값을 비교 할 예정 */\r\n");
      out.write("                 \r\n");
      out.write("               $.ajax({\r\n");
      out.write("                   url:\"sendSms.do\",\r\n");
      out.write("                   type:\"post\",\r\n");
      out.write("                   data:{to: $(\"#to\").val(),\r\n");
      out.write("                        text: $(\"#text\").val()\r\n");
      out.write("                        },\r\n");
      out.write("                 success:function(){\r\n");
      out.write("                   alert(\"해당 휴대폰으로 인증번호를 발송했습니다\");\r\n");
      out.write("                   count++;\r\n");
      out.write("                   \r\n");
